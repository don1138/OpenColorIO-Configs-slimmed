...
Shortly after I created this repo, the folks at Color Science have posted a release that comes to 124mb. If you prefer to use this full set of configs, you can follow the installation instructions shown above, with these changes:
